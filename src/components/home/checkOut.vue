          ...
          <div class="payInfo" v-if="orderDetail.refundVO">
            ...
            <div class="content" v-else>
              <div class="lists">
                ...
                <div class="list">
                  <el-button type="primary" :loading="false" class="btn green"  @click="payInfoClick()" v-if="!orderDetail.deposits[0].refund && !orderDetail.isFreeDeposit">退款</el-button>
                </div>
              </div>
            </div>
          </div>
      ...
      quitTig() {
        this.refundHandle({
          data:{
            ...
            ischeckOut: false,
            payFlowId: this.changeItem.payFlowId
          },
          onsuccess:(body)=>{
            if(body.data.code == 0){
              this.payTig = false;

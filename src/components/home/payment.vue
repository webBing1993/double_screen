      ...
      <div class="channelDetail" v-if="channelDetail1">
        ...
        <div class="detail">
          <div class="detail_content">
            ...
            <div class="btns" v-if="((!detailVal.refundModel || detailVal.refundModel == null) && parseFloat(detailVal.refundFeeStr * 100) != 0) || ((!detailVal.refundModel || detailVal.refundModel == null) && parseFloat(detailVal.refundFeeStr * 100) == 0 && tradeManager)">
